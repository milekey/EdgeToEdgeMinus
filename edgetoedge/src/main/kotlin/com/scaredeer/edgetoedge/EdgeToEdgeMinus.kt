 ...
 */
@file:JvmName("EdgeToEdgeMinus")

package com.scaredeer.edgetoedge
...
private class EdgeToEdgeApi23 : EdgeToEdgeBase() {
    ...
    override fun setUp(
        ...
        statusBarColorDefault = window.statusBarColor
        navigationBarColorDefault = window.navigationBarColor
        isAppearanceLightStatusBarsDefault =
...
private open class EdgeToEdgeApi26 : EdgeToEdgeBase() {
    ...
    override fun setUp(
        ...
        WindowInsetsControllerCompat(window, view).run {
            isAppearanceLightStatusBarsDefault = isAppearanceLightStatusBars
            isAppearanceLightNavigationBarsDefault = isAppearanceLightNavigationBars
        }
...
private open class EdgeToEdgeApi28 : EdgeToEdgeApi26() {
    ...
    @DoNotInline
    override fun adjustLayoutInDisplayCutoutMode(window: Window) {
        layoutInDisplayCutoutModeDefault = window.attributes.layoutInDisplayCutoutMode
...
private open class EdgeToEdgeApi29 : EdgeToEdgeApi28() {
    ...
    override fun setUp(
        ...
        statusBarColorDefault = window.statusBarColor
        navigationBarColorDefault = window.navigationBarColor
        isStatusBarContrastEnforcedDefault = window.isStatusBarContrastEnforced
        isNavigationBarContrastEnforcedDefault = window.isNavigationBarContrastEnforced
        WindowInsetsControllerCompat(window, view).run {
            isAppearanceLightStatusBarsDefault = isAppearanceLightStatusBars
            isAppearanceLightNavigationBarsDefault = isAppearanceLightNavigationBars
        }
...
var isEnabled = false
private var statusBarColorDefault: Int = 0
private var navigationBarColorDefault: Int = 0
private var isStatusBarContrastEnforcedDefault = false
private var isNavigationBarContrastEnforcedDefault = false
private var isAppearanceLightStatusBarsDefault = false
private var isAppearanceLightNavigationBarsDefault = false
private var layoutInDisplayCutoutModeDefault: Int = 0

private var RevertImpl: RevertEdgeToEdgeImpl? = null

fun ComponentActivity.revertEdgeToEdge() {
    val impl =
        RevertImpl
            ?: if (Build.VERSION.SDK_INT >= 30) {
                RevertEdgeToEdgeApi30()
            } else if (Build.VERSION.SDK_INT >= 29) {
                RevertEdgeToEdgeApi29()
            } else if (Build.VERSION.SDK_INT >= 28) {
                RevertEdgeToEdgeApi28()
            } else if (Build.VERSION.SDK_INT >= 26) {
                RevertEdgeToEdgeApi26()
            } else if (Build.VERSION.SDK_INT >= 23) {
                RevertEdgeToEdgeApi23()
            } else
                if (Build.VERSION.SDK_INT >= 21) {
                    RevertEdgeToEdgeApi21()
                } else {
                    RevertEdgeToEdgeBase()
                }
                    .also { RevertImpl = it }
    impl.setUp(window)
    impl.adjustLayoutInDisplayCutoutMode(window)
...
private interface RevertEdgeToEdgeImpl {
...
private open class RevertEdgeToEdgeBase : RevertEdgeToEdgeImpl {
...
@RequiresApi(21)
private class RevertEdgeToEdgeApi21 : RevertEdgeToEdgeBase() {
...
@RequiresApi(23)
private class RevertEdgeToEdgeApi23 : RevertEdgeToEdgeBase() {

    @Suppress("DEPRECATION")
    @DoNotInline
    override fun setUp(window: Window) {
        WindowCompat.setDecorFitsSystemWindows(window, true)
        window.statusBarColor = statusBarColorDefault
        window.navigationBarColor = navigationBarColorDefault
...
@RequiresApi(26)
private open class RevertEdgeToEdgeApi26 : RevertEdgeToEdgeBase() {
    ...
    override fun setUp(window: Window) {
        ...
        WindowInsetsControllerCompat(window, window.decorView).run {
            isAppearanceLightStatusBars = isAppearanceLightStatusBarsDefault
            isAppearanceLightNavigationBars = isAppearanceLightNavigationBarsDefault
        }
    }
}

@RequiresApi(28)
private open class RevertEdgeToEdgeApi28 : RevertEdgeToEdgeApi26() {

    @DoNotInline
    override fun adjustLayoutInDisplayCutoutMode(window: Window) {
        window.attributes.layoutInDisplayCutoutMode = layoutInDisplayCutoutModeDefault
    }
}

@RequiresApi(29)
private open class RevertEdgeToEdgeApi29 : RevertEdgeToEdgeApi28() {
    ...
    override fun setUp(window: Window) {
        ...
        window.statusBarColor = statusBarColorDefault
        window.navigationBarColor = navigationBarColorDefault
        window.isStatusBarContrastEnforced = isStatusBarContrastEnforcedDefault
        window.isNavigationBarContrastEnforced = isNavigationBarContrastEnforcedDefault
        WindowInsetsControllerCompat(window, window.decorView).run {
            isAppearanceLightStatusBars = isAppearanceLightStatusBarsDefault
            isAppearanceLightNavigationBars = isAppearanceLightNavigationBarsDefault
        }
...
@RequiresApi(30)
private class RevertEdgeToEdgeApi30 : RevertEdgeToEdgeApi29() {
